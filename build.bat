...
echo Building Bob...
clang-cl /nologo /std:c11 /W4 /WX /Zi /Od src\base.c src\logger.c src\profiler.c src\bob_runtime.c src\executor.c src\c_include_scan.c src\elf_adapter.c src\platform\platform_win32.c src\vcvars_cache.c src\bob.c ^
    /Isrc ^
...
echo Building tests...
clang-cl /nologo /std:c11 /W4 /WX /Zi /Od src\base.c src\logger.c src\profiler.c src\bob_runtime.c src\executor.c src\c_include_scan.c src\elf_adapter.c src\platform\platform_win32.c src\vcvars_cache.c tests\tests.c ^
    /Isrc ^
    /Ielf\include /Ielf\src\base /Ielf\src\api /Ielf\src\core ^
    /Ielf\src\core\table /Ielf\src\core\atom /Ielf\src\platform ^
    /Ielf\src\vm /Ielf\src\libs /Ielf\src\compiler ^
